...
window.top = window
window.DOMParser = function (options) {
}
...
function _0x11a7a2(_0x193f00, _0x1cfe89) {
    ...
    eval('b64pad = window[\'$_zw\'][9][\'length\'];');
...
encrypt_m1 = function (_$Wa) {

    document.cookie = 'm=' + _0x474032(_$Wa) + ';\x20path=/';
...
encrypt_m2 = function (t) {
    var mm = _0x499969(_0x41873d(t));
    window['_$is'] = t;
    window['_$pr']['push'](mm);
...
encrypt_r = function () {
    ...
    var _$Ww = CryptoJS['enc']['Utf8']['parse'](window['_$pr']['toString']())

    var _0x29dd83 = CryptoJS['AES']['encrypt'](_$Ww, window['_$qF'], {
...
encrypt = function () {
    ...
    var t2 = new Date()['valueOf']().toString();
    m = encrypt_m2(t2);
    encrypt_r();
    return {
        cook: 'm=' + m + '; RM4hZBv0dDon443M=' + window['_$ss'],
        t1: t1,
        t2: parseInt(t2),
    };
}
